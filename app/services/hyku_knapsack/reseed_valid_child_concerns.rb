...
module HykuKnapsack
  ...
  #
  # The mirror image is `self.valid_parent_concern?`: a type returning false accepts
  # no children at all, so its own list is emptied. Types that do not define it
  # remain valid parents by default.
